...
([zk-plus.github.io](https://zk-plus.github.io/tutorials/basics/hashing-algorithms-benchmarks)).
...
[sha256-prover-comparison](https://github.com/Sladuca/sha256-prover-comparison)
...
- [sha256-prover-comparison](https://github.com/Sladuca/sha256-prover-comparison) — Plonky2/Halo2/Groth16 SHA-256 proving benchmarks
- [SHA-256 vs. RISC Zero — Lita benchmarks](https://lita.gitbook.io/lita-documentation/architecture/benchmarks/sha-256-vs.-risc-zero)
- [Why We Chose Poseidon2](https://medium.com/@trusts-stack-network/why-we-chose-poseidon2-a-hash-function-that-actually-understands-math-9422204f6caf) — constraint-count comparison
- [ZoKrates hashing-algorithm benchmarks](https://zk-plus.github.io/tutorials/basics/hashing-algorithms-benchmarks)
- [zk-Bench: A Toolset for Comparative Evaluation of ZK proof systems](https://eprint.iacr.org/2023/1503.pdf)
